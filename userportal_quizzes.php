...
<body>
    ...
    while($row = mysqli_fetch_array($res)){
        echo "<tr><td>" . $row['quizname'] . "</td><td>" . $row['totalques'] . "</td><td>" . $row['correctno'] . "</td><td>" .-1 . "</td><td>"; ?>  <a href="instructions.php?n=<?php echo $row['quizid'] ?>&total=<?php echo $row['totalques'] ?>&dur=<?php echo $row['testtime'] ?>" id="attempt">Attempt quiz</a> <?php echo "</td></tr>";
    }
    echo "<table>";
    ?>
    </section>
